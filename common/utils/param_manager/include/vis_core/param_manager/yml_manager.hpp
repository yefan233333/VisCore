...
#define YML_DEBUG 1
#if YML_DEBUG
#define YML_DEBUG_PASS_(msg...) VISCORE_PASS_INFO(msg)
#define YML_DEBUG_WARNING_(msg...) VISCORE_WARNING_INFO(msg)
#define YML_DEBUG_INFO_(msg...) VISCORE_NORMAL_INFO(msg)
#else
#define YML_DEBUG_PASS_(msg...) ((void)0)
#define YML_DEBUG_WARNING_(msg...) ((void)0)
#define YML_DEBUG_INFO_(msg...) ((void)0)
#endif
