...
#
#   [可选] DEPENDS - 依赖的其他VisCore模块列表(无需前缀)
...
function(VisCore_add_module module_name)
    ...
    # 记录构建的模块 
    if(NOT MD_INTERFACE)
        set(VISCORE_MODULES_PUBLIC ${VISCORE_MODULES_PUBLIC} ${module_lib_name} CACHE INTERNAL "存储VisCore公共模块" FORCE)
    else()
        set(VISCORE_MODULES_INTERFACE ${VISCORE_MODULES_INTERFACE} ${module_lib_name} CACHE INTERNAL "存储VisCore接口模块" FORCE)
    endif()
    set(VISCORE_MODULES_BUILD ${VISCORE_MODULES_BUILD} ${module_lib_name} CACHE INTERNAL "存储VisCore构建库" FORCE)
endfunction()
